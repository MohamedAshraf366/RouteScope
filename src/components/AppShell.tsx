...
import { Map, Compass, ArrowLeftRight, PenLine, Menu, X, Github, Linkedin, Globe } from "lucide-react";
import { useApp } from "@/lib/app-context";

const nav = [
  { to: "/", label: "Converter", icon: ArrowLeftRight, desc: "KML · KMZ · TAB · GeoJSON" },
  { to: "/viewer", label: "Route viewer", icon: Map, desc: "Inspect KML / KMZ + drive time" },
  { to: "/draw", label: "Draw & upload", icon: PenLine, desc: "Trace polygons, export them" },
