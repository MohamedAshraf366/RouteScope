...
function ExplorePage() {
  ...
  return (
    ...
    >
      <PageGuide
        what="Browse any place in the world on top of OpenStreetMap, Bing or Google base layers, select an area, and export that area — including the map imagery itself — for use in other GIS tools."
        steps={[
          {
            title: "Find a place",
            body: "Type a city, governorate or landmark in the search box and press Search, then pick one of the results to fly there.",
          },
          {
            title: "Choose a basemap",
            body: "Switch between OpenStreet, Bing, Bing Satellite/Hybrid, Google, Google Satellite/Hybrid/Terrain in the Basemap panel.",
          },
          {
            title: "Select an area",
            body: "Use Square, Circle or Pin shape on the map to outline the zone you care about; its size is shown once drawn.",
          },
          {
            title: "Export it",
            body: "Pick an output format and image quality, then download the area — optionally with the basemap imagery attached as a ground overlay.",
          },
        ]}
        notes={[
          "Search is powered by OpenStreetMap Nominatim; basemap tiles remain subject to each provider's terms.",
          "Higher image quality means a much larger download — the estimated size is shown before you export.",
        ]}
      />
