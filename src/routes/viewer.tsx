...
function Index() {
  ...
  return (
    ...
    >
      <PageGuide
        what="Open a KML or KMZ route on an interactive map, measure how long it is, and estimate how long it takes to drive — either for the whole route or only the part inside an area you select."
        steps={[
          {
            title: "Load a route",
            body: "Use the upload button at the top right, or drag a .kml / .kmz file straight onto the map panel.",
          },
          {
            title: "Read the route",
            body: "The route is drawn and the map zooms to fit it. Total length appears in the stats panel underneath.",
          },
          {
            title: "Focus on an area (optional)",
            body: "Use the Square, Circle or Pin shape tool on the map to select a zone — the stats then describe just that zone.",
          },
          {
            title: "Set speed and export",
            body: "Enter an average speed and a traffic multiplier to get normal and busy-hour drive times, and export a selected area as GeoJSON, KML, KMZ or MapInfo TAB.",
          },
        ]}
        notes={["Files are parsed locally in your browser; nothing is sent anywhere."]}
      />
      {error && (
